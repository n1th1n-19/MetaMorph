  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <link rel="icon" href="/assets/images/logooo.png" type="image/png" />
        <link rel="apple-touch-icon" href="/assets/images/logooo.png" />
        <link rel="manifest" href="/manifest.json" />
        <link rel="preconnect" href="https://fonts.googleapis.com" />
        <link rel="preconnect" href="https://fonts.gstatic.com" crossOrigin="anonymous" />
        <link 
          href="https://fonts.googleapis.com/css2?family=Gugi&family=Inter:wght@100;200;300;400;500;600;700;800;900&display=swap" 
          rel="stylesheet" 
        />
        <script
